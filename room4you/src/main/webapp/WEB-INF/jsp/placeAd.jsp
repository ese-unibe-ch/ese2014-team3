...
<div class="container">
	...
	<a href="<spring:url value="/placeNewAd.html"/>"
...
<script>
	$(document).ready(
			function() {
				...
				if ($.trim($("#visitors").html()) == '') {
					$('#visitors').html("No visitors");
				}
				if ($.trim($("#favCandidates").html()) == '') {
					$('#favCandidates').html("To compile your favourites click on Appointments and select your favourites");
				}
			});
</script>
