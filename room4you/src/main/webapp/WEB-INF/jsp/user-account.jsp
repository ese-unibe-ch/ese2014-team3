	...
	<div class="scroll-area" data-spy="scroll" data-target="navbarCollapse"
		...
		<div id="bookmarkedAds" class="container">
			...
			<div class="row" id="messages">
				...
				<c:forEach items="${conversationsReceived}" var="message">
					<div class="col-md-6 col-md-4 user-messages">
						<div style="width: 75%; height: 75%; padding-bottom: 5%"
							id="thumbnail" class="thumbnail">

							<a href="<spring:url value="/ads/${message.messageAd.id}.html"/>"> <c:choose>
									<c:when test="${not empty message.messageAd.images}">
										<img
											src="data:image/jpeg;base64,${message.messageAd.images[0].imageAsString}"
											class="img-responsive"></img>
									</c:when>
									<c:otherwise>
										<img
							...
							<div class="caption">
								<h4>${message.messageAd.title}</h4>
								<p>Received from: ${message.sender.name}</p>
...
<!-- 									class="btn btn-danger triggerRemove"> Delete chat </a> -->
			...
			<div class="row" id="messages">
				...
				<c:forEach items="${conversationsSent}" var="message">
					<div class="col-md-6 col-md-4 user-messages">
						<div style="width: 75%; height: 75%; padding-bottom: 5%"
							id="thumbnail" class="thumbnail">
							...
							<div class="caption">
								<h4>${message.messageAd.title}</h4>
								<p>Sent to: ${message.recipient.name}</p>
