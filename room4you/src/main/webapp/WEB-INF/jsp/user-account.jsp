		...
		<c:forEach items="${usera.receivedApplications}" var="application">
			<tr>
									...
									<div id="myModalContent" class="modal-body">
										...
										<div class="col-md-3">
											<div id="datetimepicker1" class="input-append">
												<input style="width: 70px" data-format="dd-MM-yyyy"
													type="text" name="appointments"></input> <span
										...
										<div class="col-md-3">
											<div id="datetimepicker2" class="input-append">
												<input style="width: 60px" data-format="HH:mm" type="text"
													name="appointments"></input> <span class="add-on"> <i
										...
										<div class="form-group">
											<label for="name" class="col-sm-2 control-label">Number
												of Visitors:</label>
											<div class="col-sm-10">
												<input name="appointments" cssClass="form-control" />
											</div>
										</div>
				...
				<br /> <script type="text/javascript">
					...
					</div> <!-- adding more fileinputs --> <script>
						$(document)
								.ready(
										function() {
								...
								.click(
										function() {
											...
											$('#myModalContent')
												  ...
												  '<div class="col-md-2"> 				  													'
												+ '	<div id="datetimepicker1" class="input-append">   													'
												+ '	<input style="width:50px" data-format="yyyy-MM-dd" type="text" name="appointments"></input> <span 	'
												+ '		class="add-on"> <i data-time-icon="icon-time" 													'
												+ '		data-date-icon="icon-calendar"> </i> 		  													'
												+ '	</span>																								'
												+ ' </div>																								'
												...
												+		'	<script type="text/javascript"> 						'
												+		'		$(function() {										'
												+		'			$('#datetimepicker'+docCount).datetimepicker({	'
												+		'				pickTime : false							'
												+		'			});												'
												+		'		});													'
												+		'	</scr+ipt>												'
												...
												+		'	<div class="col-md-2">																			'
												+		'		<div id="datetimepicker2" class="input-append">												'
												+		'			<input style="width:50px" data-format="HH:mm" type="text" name="appointments"></input>	'
