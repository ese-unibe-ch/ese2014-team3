      ...
      <div id="myModalContent" class="modal-body">
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="datetime-local" name="appointments[]" class="form-control" />
						<button id="addAppointment" type="button" class="btn btn-default btn-sm right-block">
			...
			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">Number
					of Visitors:</label>
				<div class="col-sm-10">
					<input type="number" name="appointments" class="form-control" />
				</div>
			</div>
